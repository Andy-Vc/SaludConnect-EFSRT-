...
CREATE TABLE TB_APPOINTMENTS (
    ...
    ID_PATIENT INT NOT NULL REFERENCES TB_USERS(ID_USER), -- Paciente que agenda
    ID_DOCTOR INT NOT NULL REFERENCES TB_USERS(ID_USER),   -- Doctor asignado
    ID_SPECIALTY INT NOT NULL REFERENCES TB_SPECIALTIES(ID_SPECIALTY), -- Especialidad de la cita
