...
INSERT INTO TB_USERS (FIRST_NAME, LAST_NAME_PAT, LAST_NAME_MAT, DOCUMENT, BIRTHDATE, PHONE, GENDER, EMAIL, PASSWORD_HASH, ID_ROLE, DATE_REGISTER, PROFILE_PICTURE)
VALUES
('Admin', 'Principal', 'Uno', '123456723', '10/05/1990', '912345890', 'M', 'admin@example.com', 'clave123', 2, '10/10/2024 10:00:00', NULL),
('Juan', 'Pérez', 'González', '123456789', '10/05/1990', '923457890', 'M', 'juan.perez@example.com', 'clave123', 1,'15/01/2025 14:30:00', NULL),
('María', 'López', 'Hernández', '987654321', '25/08/1985', '987654322', 'F', 'maria.lopez@example.com', 'clave123', 3,'01/12/2024 08:00:00', NULL),
('Carlos', 'Ramírez', 'Sánchez', '456789123', '15/12/1992', '987654323', 'M', 'carlos.ramirez@example.com', 'clave123', 3,'05/12/2024 09:15:00', NULL),
('Ana', 'García', 'Díaz', '111222333', '01/01/2000', '900111222', 'F', 'ana.garcia@example.com', 'clave123', 1,'20/02/2025 17:00:00', NULL);
GO
...
CREATE TABLE TB_MEDICAL_RECORDS (
    ...
    DATE_REPORT DATETIME NULL DEFAULT GETDATE(),
...
INSERT INTO TB_MEDICAL_RECORDS (ID_APPOINTMENT, OBSERVATIONS, DIAGNOSIS, TREATMENT) VALUES
(1, 
...
-- El precio se obtiene de TB_SERVICES
CREATE TABLE TB_ADDITIONAL_SERVICES (
    ...
    UNIQUE (ID_RECORD, ID_SERVICE)  -- Un registro médico no puede tener el mismo servicio duplicado
);
GO

INSERT INTO TB_ADDITIONAL_SERVICES (ID_RECORD, ID_SERVICE, STATE) VALUES
(1, 2, 'P'),   -- Electrocardiograma
(1, 6, 'P');   -- Prueba de Glucosa
GO
