...
    ID_ROLE INT NOT NULL REFERENCES TB_ROLES(ID_ROLE),
	ID_E_CONTACT INT,
    DATE_REGISTER DATETIME NOT NULL DEFAULT GETDATE(), -- Usando DATETIME
...
-- Doctor 3 (María López) - Cardiología: 300 min / 20 min = 15 slots
(3, 1, '2025-10-20 08:00:00', '2025-10-20 13:00:00', 20), 
-- Doctor 4 (Carlos Ramírez) - Dermatología: 240 min / 20 min = 12 slots
(4, 4, '2025-10-21 14:00:00', '2025-10-21 18:00:00', 20), 
-- Turno largo: Doctor 4 (Carlos Ramírez): 360 min / 20 min = 18 slots
...
-- Cita 1 (Completada 'A') - Lunes 20/10 a las 8:00
(2, 3, 1, '2025-10-20 08:00:00', 'A', 150.00, 1), 
-- Cita 2 (Pendiente 'P') - Martes 21/10 a las 14:00
(5, 4, 2, '2025-10-21 14:00:00', 'P', 120.00, 4), 
-- Cita 3 (Cancelado 'X') - Viernes 24/10 a las 10:20 (Slot válido)
(2, 4, 2, '2025-10-24 10:20:00', 'X', 120.00, 3), 
-- Cita 4 (Inasistencia 'N') - Lunes 20/10 a las 08:20 (Slot válido)
(5, 3, 8, '2025-10-20 08:20:00', 'N', 140.00, 5); 
GO
...
('Electrocardiograma', 'Prueba diagnóstica.', 80.00, 15, 1), -- ID 2
...
('Prueba de Glucosa en Ayunas', 'Análisis clínico.', 60.00, 20, 8); -- ID 6
GO
...
    DATE_REPORT DATETIME NOT NULL DEFAULT GETDATE(), -- Usando DATETIME
