...
BEGIN
    ...
    BEGIN
        RAISERROR('El nÃºmero de documento %s ya existe', 16, 1, @DOCUMENT);
        RETURN;
    END

    IF EXISTS (SELECT 1 FROM TB_USERS WHERE EMAIL = @EMAIL)
    BEGIN
        RAISERROR('El correo electrÃ³nico %s ya existe', 16, 1, @EMAIL);
        RETURN;
    END
...
BEGIN
    ...
    BEGIN
        RAISERROR('Estado invÃ¡lido. Use: A=Atendido, P=Pendiente, X=Cancelado, N=No asistiÃ³', 16, 1);
        RETURN;
    END
...
/* ============================================
   ...
   Estados: A=Atendido, P=Pendiente, X=Cancelado, N=No asistiÃ³
   ============================================ */
...
BEGIN
    ...
    BEGIN
        SELECT 
            ...
            'Error: DuraciÃ³n de cita invÃ¡lida.' AS StatusMessage;
        RETURN;
    END
    ...
    SELECT
        ...
        @TotalMinutes AS TotalMinutesInShift,
        @SlotDuration AS SlotDurationMinutes,
        'CÃ¡lculo exitoso' AS StatusMessage;
END
GO
